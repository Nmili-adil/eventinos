...
const Header = () => {
    return (
        <div className="flex flex-col bg-white/80 backdrop-blur-md border-b border-gray-200/60 shadow-sm sticky top-0 z-50 w-full">
            {/* Top Header Section */}
            <div className="flex items-center justify-between h-14 py-3   px-6">

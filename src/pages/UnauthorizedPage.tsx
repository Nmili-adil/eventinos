        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-500 via-red-600 to-rose-600 p-6 md:p-8 text-center relative">
            ...
            <div className="relative">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 drop-shadow-lg">401</h1>
              <p className="text-lg md:text-xl font-semibold text-white/90 drop-shadow-md">Unauthorized Access</p>
            </div>
          </div>
